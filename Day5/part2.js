...
// console.log(jobDate["hits"]);
// console.log(jobDate.hits[0]);
// console.log(`First job tittle:\n${jobDate.hits[0].jobTitle}`);
// console.log(jobDate.hits[0].benefits);
// let len = jobDate.hits[0].benefits.length;
// console.log('First job hit benefit:');
// for(let i = 0; i < len; i++) {
//     console.log(`- ${jobDate.hits[0].benefits[i].benefitValue}`);
// }
// console.log(`First job tittle:\n${jobDate.hits[0].jobTitle}`);

// let len = jobDate.hits.length;
// for(let i = 0; i < len; i++) {
//     console.log(`${jobDate.hits[i].jobTitle}`);
//     console.log(`Benefits:`);
//     let lenBenefit = jobDate.hits[i].benefits.length;
//     console.log('First job hit benefit:'); 
//     for(let j = 0; j < lenBenefit; j++) {
//         console.log(`- ${jobDate.hits[i].benefits[j].benefitValue}`);  
//     }
//     console.log('----------------------------------');
// }
...
let len = jobDate.hits.length;
for(let i = 0; i < len; i++) {
    let lenOfBenefit = jobDate.hits[i].benefits.length;
    let lenOfSkills = jobDate.hits[i].skills.length;
    let {jobTitle, jobSalary, locationVIs} = jobDate.hits[i];
    console.log(`Tittle: ${jobTitle}`);
    console.log(`Salary: ${jobSalary}`);
    console.log(`Location: \n- ${locationVIs}`);
    console.log(`Benefits:`);
    for(let j = 0; j < lenOfBenefit; j++) {
        let {benefitValue} = jobDate.hits[i].benefits[j];
        console.log(`- ${benefitValue}`);
    }

    console.log("Skills:");
    for(let j = 0; j < lenOfSkills; j++){
        let skill = jobDate.hits[i].skills[j];
        console.log(`- ${skill}`);
    }
    console.log('------------------------------------------');
}